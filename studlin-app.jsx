            ...
            {msgs.map((m,i)=>(
              <div key={i} style={{display:"flex",gap:10,alignItems:"flex-start",flexDirection:m.r==="user"?"row-reverse":"row"}}>
                ...
                <div style={{maxWidth:"76%",padding:"10px 13px",borderRadius:8,fontSize:13,lineHeight:1.65,background:m.r==="ai"?T.card2:T.lime,color:m.r==="ai"?T.text:T.bg,border:m.r==="ai"?`1px solid ${T.border}`:"none",whiteSpace:"pre-wrap"}}>
                  {m.file&&(
                    <div style={{display:"inline-block",width:140,borderRadius:10,overflow:"hidden",border:`1px solid ${m.r==="ai"?T.border:T.bg+"25"}`,background:m.r==="ai"?T.card:T.bg+"12",marginBottom:m.t&&m.t!=="Uploaded "+m.file?8:0}}>
                      <div style={{height:90,background:m.r==="ai"?"rgba(255,255,255,0.04)":"rgba(0,0,0,0.06)",display:"flex",alignItems:"center",justifyContent:"center",borderBottom:`1px solid ${m.r==="ai"?T.border:T.bg+"18"}`}}>
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke={m.r==="ai"?T.muted:T.bg+"70"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                      </div>
                      <div style={{padding:"8px 10px"}}>
                        <div style={{fontSize:11.5,fontWeight:500,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",lineHeight:1.3}}>{m.file.replace(/\.[^.]+$/,"")}</div>
                        <div style={{marginTop:4}}><span style={{fontSize:9,fontWeight:700,letterSpacing:"0.08em",background:m.r==="ai"?T.muted+"22":T.bg+"20",padding:"2px 6px",borderRadius:3,textTransform:"uppercase"}}>{m.file.split(".").pop()}</span></div>
                      </div>
                    </div>
                  )}
